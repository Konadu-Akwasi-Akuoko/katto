		...
		<section className="flex flex-col gap-6">
			<div className="flex flex-col gap-2">
				<h1 className="font-serif text-3xl font-semibold">
					Where does your footage live?
				</h1>
				<p className="text-fg-muted">
					katto keeps every project as plain folders under one studio root. An
					external SSD is the comfortable choice; any folder works.
				</p>
			</div>
			<div className="flex items-center gap-3">
				...
				{check && (
					<span className="font-mono text-sm text-fg-muted">{check.path}</span>
				)}
			</div>
			{warnings.length > 0 && (
